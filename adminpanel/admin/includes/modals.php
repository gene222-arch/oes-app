   ...
   <form class="refreshFrm" id="addCourseFrm" method="post">
     <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Preferred Track</h5>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            <label>Track</label>
            <input type="" name="course_name" id="course_name" class="form-control" placeholder="Input Preferred Track" required="" autocomplete="off">
          </div>
        </div>
      </div>
   ...
   <form class="refreshFrm" id="addExamFrm" method="post">
     <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            <label>Select Preferred Track</label>
              ...
              <?php 
                ...
                if($selCourse->rowCount() > 0)
                {
                  while ($selCourseRow = $selCourse->fetch(PDO::FETCH_ASSOC)) { ?>
                     <option value="<?= $selCourseRow['cou_id'] ?>"><?= $selCourseRow['cou_name'] ?></option>
                  <?php }
                }
                else
                { ?>
                  <option value="0">No Preferred Track Found</option>
                <?php }
               ?>
            </select>
          </div>
